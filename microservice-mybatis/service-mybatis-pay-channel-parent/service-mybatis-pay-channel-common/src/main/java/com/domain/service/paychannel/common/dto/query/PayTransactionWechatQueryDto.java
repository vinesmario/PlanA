package com.domain.service.paychannel.common.dto.query;
 ...
 * @date 2018-01-18
 */
@ApiModel(value = "PayTransactionWechat", description = "PayTransactionWechat")
@Data
public class PayTransactionWechatQueryDto extends QueryDto {
