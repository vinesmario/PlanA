...
import com.domain.biz.model.dto.netty.A111DTO;
import com.domain.biz.model.service.netty.A111MessageService;
...
public class A111Test extends BaseJavaSamplerClient {

    /**
     * @param map
     */
    public void addMessageBaseDataParamName(Map<String, String> map) {
        Field[] fields = A111DTO.class.getDeclaredFields();
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        getCoreMessageList().add(new A111MessageService());
        return super.runTest(javaSamplerContext);
    }

    public static void main(String[] args) {
        A111Test a = new A111Test();
